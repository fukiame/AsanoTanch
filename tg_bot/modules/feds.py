...
@spamcheck
async def new_fed(update, context: ContextTypes.DEFAULT_TYPE):
...
@spamcheck
async def del_fed(update, context: ContextTypes.DEFAULT_TYPE):
    chat = update.effective_chat  # type: Optional[Chat]
    user = update.effective_user  # type: Optional[User]
    args = context.args
    if chat.type != "private":
...
@spamcheck
async def fed_chat(update, _: ContextTypes.DEFAULT_TYPE):
    chat = update.effective_chat  # type: Optional[Chat]
...
@spamcheck
async def join_fed(update, context: ContextTypes.DEFAULT_TYPE):
    chat = update.effective_chat  # type: Optional[Chat]
    user = update.effective_user  # type: Optional[User]
...
@spamcheck
async def leave_fed(update, context: ContextTypes.DEFAULT_TYPE):
    chat = update.effective_chat  # type: Optional[Chat]
    user = update.effective_user  # type: Optional[User]
...
@spamcheck
async def user_join_fed(update, context: ContextTypes.DEFAULT_TYPE):
...
@spamcheck
async def user_demote_fed(update, context: ContextTypes.DEFAULT_TYPE):
    chat = update.effective_chat  # type: Optional[Chat]
    user = update.effective_user  # type: Optional[User]
    args = context.args
...
@spamcheck
async def fed_info(update, context: ContextTypes.DEFAULT_TYPE):
    chat = update.effective_chat  # type: Optional[Chat]
    user = update.effective_user  # type: Optional[User]
    args = context.args
    if args:
...
@spamcheck
async def fed_admin(update, context: ContextTypes.DEFAULT_TYPE):
...
@spamcheck
async def fed_ban(update, context: ContextTypes.DEFAULT_TYPE):  # sourcery no-metrics
    ...
    if int(user_id) in SUDO_USERS:
        await message.reply_text("I will not ban a SUDO user!")
        return
    ...
    strt_msg = await update.effective_message.reply_text(starting, parse_mode=ParseMode.HTML)
...
@spamcheck
async def unfban(update, context: ContextTypes.DEFAULT_TYPE):
    chat = update.effective_chat  # type: Optional[Chat]
    user = update.effective_user  # type: Optional[User]
...
async def set_frules(update, context: ContextTypes.DEFAULT_TYPE):
...
@spamcheck
async def get_frules(update, context: ContextTypes.DEFAULT_TYPE):
    chat = update.effective_chat  # type: Optional[Chat]
    args = context.args
...
@spamcheck
async def fed_broadcast(update, context: ContextTypes.DEFAULT_TYPE):
    msg = update.effective_message  # type: Optional[Message]
    user = update.effective_user  # type: Optional[User]
    chat = update.effective_chat  # type: Optional[Chat]
    args = context.args
...
@spamcheck
async def fed_ban_list(update, context: ContextTypes.DEFAULT_TYPE):  # sourcery no-metrics
    chat = update.effective_chat  # type: Optional[Chat]
    user = update.effective_user  # type: Optional[User]
    args = context.args
    ...
    if args:
        if args[0] == "json":
            ...
            with BytesIO(str.encode(backups)) as output:
                output.name = "{}_fbanned_users.json".format(application.bot.username)
                await update.effective_message.reply_document(
                    document=output,
                    filename="{}_fbanned_users.json".format(application.bot.username),
            ...
            for users in getfban:
                ...
                backups += "\n"
            with BytesIO(str.encode(backups)) as output:
                output.name = "{}_fbanned_users.csv".format(application.bot.username)
                await update.effective_message.reply_document(
                    document=output,
                    filename="{}_fbanned_users.csv".format(application.bot.username),
...
@spamcheck
async def fed_notif(update, context: ContextTypes.DEFAULT_TYPE):
    chat = update.effective_chat  # type: Optional[Chat]
    user = update.effective_user  # type: Optional[User]
    msg = update.effective_message  # type: Optional[Message]
    args = context.args
...
@spamcheck
async def fed_chats(update, context: ContextTypes.DEFAULT_TYPE):
    chat = update.effective_chat  # type: Optional[Chat]
    user = update.effective_user  # type: Optional[User]
    args = context.args
...
@spamcheck
async def fed_import_bans(update, context: ContextTypes.DEFAULT_TYPE):  # sourcery no-metrics
    chat = update.effective_chat  # type: Optional[Chat]
    user = update.effective_user  # type: Optional[User]
    msg = update.effective_message  # type: Optional[Message]
    chat_data = context.chat_data
...
async def del_fed_button(update, context: ContextTypes.DEFAULT_TYPE):
...
@spamcheck
async def fed_stat_user(update, context: ContextTypes.DEFAULT_TYPE):  # sourcery no-metrics
    user = update.effective_user  # type: Optional[User]
    msg = update.effective_message  # type: Optional[Message]
    args = context.args
...
@spamcheck
async def set_fed_log(update, context: ContextTypes.DEFAULT_TYPE):
    chat = update.effective_chat  # type: Optional[Chat]
    user = update.effective_user  # type: Optional[User]
    args = context.args
...
@spamcheck
async def unset_fed_log(update, context: ContextTypes.DEFAULT_TYPE):
    chat = update.effective_chat  # type: Optional[Chat]
    user = update.effective_user  # type: Optional[User]
    msg = update.effective_message  # type: Optional[Message]
    args = context.args
...
@spamcheck
async def subs_feds(update, context: ContextTypes.DEFAULT_TYPE):
    chat = update.effective_chat  # type: Optional[Chat]
    user = update.effective_user  # type: Optional[User]
    msg = update.effective_message  # type: Optional[Message]
    args = context.args
...
@spamcheck
async def unsubs_feds(update, context: ContextTypes.DEFAULT_TYPE):
    chat = update.effective_chat  # type: Optional[Chat]
    user = update.effective_user  # type: Optional[User]
    msg = update.effective_message  # type: Optional[Message]
    args = context.args
...
@spamcheck
async def get_myfedsubs(update, context: ContextTypes.DEFAULT_TYPE):
    chat = update.effective_chat  # type: Optional[Chat]
    user = update.effective_user  # type: Optional[User]
    msg = update.effective_message  # type: Optional[Message]
    args = context.args
...
@spamcheck
async def get_myfeds_list(update, context: ContextTypes.DEFAULT_TYPE):
    chat = update.effective_chat  # type: Optional[Chat]
    user = update.effective_user  # type: Optional[User]
    msg = update.effective_message  # type: Optional[Message]
    args = context.args
...
def welcome_fed(ctx: CallbackContext, msg: Message, chat: Chat, user_id: int):
    ...
    if fban:
        ...
        try:
            ...
            await application.bot.send_message(chat.id, msgg, parse_mode="markdown")
