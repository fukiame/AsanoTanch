...
from .. import application, SUDO_USERS, DEV_USERS, spamcheck
...
async def allow_connections(update, context: ContextTypes.DEFAULT_TYPE):
...
@spamcheck
@typing_action
async def connect_chat(update, context: ContextTypes.DEFAULT_TYPE):  # sourcery no-metrics
